...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex-1 bg-white flex flex-col">
      {/* Hero Section */}
            <section role="banner" className="relative bg-brand-900 pt-16 md:pt-20 lg:pt-24 pb-8 md:pb-12 lg:pb-16 overflow-hidden h-[45vh] md:h-[55vh] lg:h-[60vh] max-h-[680px]">
